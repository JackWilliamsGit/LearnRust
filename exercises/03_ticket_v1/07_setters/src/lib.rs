...
impl Ticket {
    pub fn new(title: String, description: String, status: String) -> Ticket {
        Ticket::title_checker(&title);
        Ticket::description_checker(&description);
        Ticket::status_checker(&status);
    ...
    pub fn set_title(&mut self, title: String) {
        Self::title_checker(&title);
        self.title = title;
    }

    pub fn set_description(&mut self, description: String) {
        Self::description_checker(&description);
